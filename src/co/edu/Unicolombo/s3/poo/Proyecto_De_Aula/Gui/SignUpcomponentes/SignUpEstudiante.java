...
import co.edu.Unicolombo.s3.poo.Proyecto_De_Aula.crud.EstudianteCrud;
...
public class SignUpEstudiante extends javax.swing.JPanel {
    ...
    private EstudianteCrud estudianteCrud = new EstudianteCrud();
    ...
    private void registrarEstudiante() {
        try {
            ...
            String nombres = nombreEstTxt.getText();
            String apellidos = apellidoEstTxt.getText();
            Date nacimiento = jDateChooserEst.getDate();
            String email = correoEstTxt.getText();
            String genero = "";
            ...
            String contrasena = contraseñaEstTxt.getText();
            int identificacion;

            try {
                identificacion = Integer.parseInt(IDEstTxt.getText());
            ...
            // Crear el objeto Estudiante SIN código (la base de datos lo asignará)
            Estudiante nuevoEstudiante = new Estudiante(0, nombres, apellidos, nacimiento, email, genero, contrasena, identificacion, null, tipoUsuario, null, null);

            // Agregar el estudiante (el método debe retornar el código generado)
            int nuevoCodigo = estudianteCrud.agregarEstudiante(nuevoEstudiante);

            if (nuevoCodigo > 24023799) {
                JOptionPane.showMessageDialog(this, "Registro Exitoso.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                javax.swing.JOptionPane.showMessageDialog(jPanel1, "Su código de estudiante es: " + nuevoCodigo + ". \nADVERTENCIA: Guarde el código antes de presionar el botón 'OK'.", "Warning", javax.swing.JOptionPane.WARNING_MESSAGE);
                limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, "Error al registrar el estudiante.", "Error", JOptionPane.ERROR_MESSAGE);
            }
            
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Ocurrió un error al registrar el estudiante: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
